...
// Ищем кусок, который начинается со слов "Коды ответа", всё ещё иногда не срабатывает, на одном из тестовых запросов было "стандартные коды ответа" вместо "коды ответа". в такой ситуации охидаемо не работает
const statusCodesSection = sections.find(section => 
  section.trim().includes("**200 OK**")
);
